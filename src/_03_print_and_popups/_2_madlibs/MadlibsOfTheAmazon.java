...
String input = JOptionPane.showInputDialog("Enter an ajective");
		// Get the player to enter a type of liquid
String V1 = JOptionPane.showInputDialog("Enter a type of liquid");
		// Get the player to enter a body part
String V2 = JOptionPane.showInputDialog("Enter a body part");
		// Get the player to enter a verb
String V3 = JOptionPane.showInputDialog("Enter a verb");

		// Get the player to enter a place
String V4 = JOptionPane.showInputDialog("Enter a place");
		...
		"night. Piranhas are attracted to fresh "+V1+" and will most\n"  +
		"likely take a bite out of your "+V2+" if you "+V3+". Whatever\n"  +
		"you do, if you have an open wound, try to find another way to get\n"  +
		"back to the "+V4+". Good luck!";
